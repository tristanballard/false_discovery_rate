...
pvals=readRDS("/scratch/users/tballard/shum/class.project/pvals.USonly.rds") #192x94x8
...
dir="/scratch/users/tballard/shum/class.project/" #where to save plots
    plot.name=paste(dir,"plot.MCC.USonly.png",sep="")
